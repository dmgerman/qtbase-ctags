...
DECL|function|dynamicInfoForId
DECL|function|enumerateTimeZones
...
DECL|macro|QT_USE_REGISTRY_TIMEZONE
DECL|member|Bias
...
DECL|member|bias
DECL|member|daylightName
DECL|member|daylightTime
DECL|member|standardName
DECL|member|timezoneName
DECL|struct|QWinDynamicTimeZone
DECL|struct|_REG_TZI_FORMAT
DECL|typedef|QWinRTTimeZoneHash
