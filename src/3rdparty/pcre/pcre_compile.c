...
DECL|function|get_chr_property_list
DECL|function|get_othercase_range
DECL|function|get_repeat_base
...
DECL|macro|IS_DIGIT
DECL|macro|NAMED_GROUP_LIST_SIZE
DECL|macro|NLBLOCK
...
DECL|variable|string_pXsp
DECL|variable|string_pXwd
DECL|variable|sub_end_of_word
DECL|variable|sub_start_of_word
